...
{
    public partial class initizalMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookindID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bookings", x => x.BookindID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FeauteID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FeauteTitle = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FeauteDescription = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Features", x => x.FeauteID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDetails", x => new { x.OrderDetailID, x.ProductID, x.OrderID });
                    table.ForeignKey(
